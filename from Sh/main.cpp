...
int main(int argc, const char * argv[]) {
    ...
    auto bob = getCFlargerThanOne(75, 33);
    cout << "Bob: ";
    printCF(*bob, 5);
    
    auto dia = getCFlargerThanOne(113, 5);
    cout << "Dia: ";
    printCF(*dia, 5);
    
    unsigned int divide = division(500,5);
    cout << "Division: " << divide << "\n";
    
    int rez = gcd (48, 36);
    cout << "Answer is: " << rez << "\n";
    
    int div = division(100, 5);
    cout << "The weird division thing is: " << div << "\n";
    
    auto gold = getCF(1, bob, dia);
    cout << "Gold: ";
    printCF(*gold,50);
    cout << "\n";
